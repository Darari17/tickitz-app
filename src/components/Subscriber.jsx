export const Subscriber = () => {
  return (
    <div className="flex flex-row justify-center items-center relative mx-25">
      <form className="flex flex-col align-middle justify-center items-center w-full bg-[#2563eb] rounded-[20px] gap-7 py-10 ">
        <div>
        ...
        <div className="flex gap-5">
          ...
          <div className="absolute border-6 border-white w-[200px] h-[200px] rounded-full right-0 bottom-0 translate-y-30 translate-x-20 overflow-hidden"></div>
        </div>
      </form>
    </div>
  );
